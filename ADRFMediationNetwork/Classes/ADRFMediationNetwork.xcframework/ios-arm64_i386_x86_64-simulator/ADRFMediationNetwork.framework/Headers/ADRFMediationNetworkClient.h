...
#import "ADRFMediationNetworkResponseSerialization.h"
#import "ADRFMediationNetworkRequestSerialization.h"
//NS_ASSUME_NONNULL_BEGIN

@interface ADRFMediationNetworkClient : NSObject
...
@property (nonatomic, strong) ADRFMediationNetworkRequestSerialization *requestSerializer;
/// 响应转换器, 根据需求, 把response转成对应的responseObject
@property (nonatomic, strong) ADRFMediationNetworkResponseSerialization *responseSerializer;

+ (instancetype)adrf_sharedClient;
...
- (void)GET:(NSString *)URLString
 parameters:(id)parameters
requestSerializer:(ADRFMediationNetworkRequestSerialization *)requestSerializer
    success:(void (^)(NSURLSessionDataTask *task, NSHTTPURLResponse *response, id responseObject))success
    failure:(void (^)(NSURLSessionDataTask *task, NSHTTPURLResponse *response, NSError *error))failure;
...
- (void)GET:(NSString *)URLString
 parameters:(id)parameters
requestSerializer:(ADRFMediationNetworkRequestSerialization *)requestSerializer
responseSerializer:(ADRFMediationNetworkResponseSerialization *)responseSerializer
    success:(void (^)(NSURLSessionDataTask *task, NSHTTPURLResponse *response, id responseObject))success
    failure:(void (^)(NSURLSessionDataTask *task, NSHTTPURLResponse *response, NSError *error))failure;
